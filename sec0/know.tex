...
\caption{Repertory grid of six authors.
Grey cells score each author from the left pole (1) to the right pole
(5) of each construct; trees join rows (and columns) by percentage
match; regenerate via {\em make focus}.}
\label{fig:focus}
\end{figure}
...
dimension twice.
In this team, working at corpus scale and being AI-centred co-travel
(rows 1--2), as do primary experimentation and future-facing
prediction.
...
Thirdly, complements: Schmid and Armenti join the tree last, so
upfront design and single-artifact comprehension are scarce skills
